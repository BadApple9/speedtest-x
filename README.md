...
[![GitHub Actions Build Status](https://img.shields.io/github/actions/workflow/status/badapple9/speedtest-x/Build%20Docker%20Image)](https://img.shields.io/github/actions/workflow/status/badapple9/speedtest-x/docker-build.yml) ![GitHub last commit](https://img.shields.io/github/last-commit/badapple9/speedtest-x) ![GitHub](https://img.shields.io/github/license/badapple9/speedtest-x)
